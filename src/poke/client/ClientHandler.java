...
public class ClientHandler extends SimpleChannelUpstreamHandler {
	...
	public void handleMessage(eye.Comm.Response msg) {
		logger.info("Inside the ClientHandler.handleMessage()...");
		for (String id : listeners.keySet()) {
			...
			logger.info("Exiting the ClientHandler.handleMessage()....");
			cl.onMessage(msg);
		}
	}
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
		logger.info("Inside the ClientHandler.messageReceived()....");
		logger.info("Exiting the ClientHandler.messageReceived()....");
