...
public class HeartMonitor {
	...
	public boolean isConnected() {
		System.out.println("Inside the HeartMonitor.isConnected()...");
		if (channel == null){
			System.out.println("Exiting the HeartMonitor.isConnected()... Channel is Null...");
			return false;
		}else{
			System.out.println("Exiting the HeartMonitor.isConnected()... Channel is There...");
	...
	public boolean initiateHeartbeat() {
		System.out.println("Inside the HeartMonitor.initializeHeartbeat()...");
		...
		System.out.println("Exiting the HeartMonitor.initializeHeartbeat()...");
