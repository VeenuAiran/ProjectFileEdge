...
public class HeartbeatConnector extends Thread {
	...
	public void addConnectToThisNode(HeartbeatData node) {
		System.out.println("Entered the HeartBeatConnector.addConnectToThisNode()...");
		...
		monitors.add(hm);
		System.out.println("Exiting the HeartBeatConnector.addConnectToThisNode()...");
	}

	@Override
	public void run() {
		System.out.println("Entered the HeartBeatConnector.run()...");
		if (monitors.size() == 0) {
		...
		System.out.println("Exiting the HeartBeatConnector.run()...");
	}
